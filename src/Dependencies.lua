...
gTextures = {
    ...
    ['posts'] = love.graphics.newImage('graphics/full_sheet.png')
}
...
gFrames = {
    ...
    ['keys'] = GenerateQuadsKeys(gTextures['keys'], TILE_SIZE, TILE_SIZE),

    ['locks'] = GenerateQuadsLocks(gTextures['locks'], TILE_SIZE, TILE_SIZE),

    ['flags'] = GenerateQuadsFlags(gTextures['flags'], 16, 16),

    ['poles'] = GenerateQuadsPoles(gTextures['poles'], 16, 48),

    ['posts'] = GeneratePostQuad(gTextures['posts'], 20, 48),
